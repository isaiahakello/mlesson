...
<div class="span10">
<div style="background-color: #98AFC7; padding: 10px; color: white;"> Miscellaneous Files</div>
     <div style="height: 500px; overflow-y: auto;">
     <?php $clgroup = list_files_misc();
          if(is_array($clgroup)){  ?>
          <table class="table">
                                    <thead>
                                    <tr>
                                    ...
                                    <tbody>
                                        <?php                                        
                                         foreach($clgroup as $value){
                                            ...
                                            $hrmin=$value['hrmin'];
                                            $ampm=$value['ampm'];
                                            $thanks=$value['thankyou'];
                                            $bye=$value['invalidchoice'];
                                        ?>
                                    <tr>
                                        <td><a href="misc?change=welcome" title="change"><?php echo $welcome; ?></a>
                                            <a href="<?php echo $welcome;?>" id="listen" title="play" onclick="return playFile(this);"> 
                                            <i class="fa fa-play" style="font-size: 0.8em; color: red;"></i></a></td>
                                        <td><a href="misc?change=confirm" title="change"><?php echo $confirm; ?></a>
                                            <a href="<?php echo $confirm;?>" id="listen" title="play" onclick="return playFile(this);"> 
                                            <i class="fa fa-play" style="font-size: 0.8em; color: red;"></i></a></td>
                                        <td><a href="misc?change=hrmin" title="change"><?php echo $hrmin; ?></a>
                                            <a href="<?php echo $hrmin;?>" id="listen" title="play" onclick="return playFile(this);"> 
                                            <i class="fa fa-play" style="font-size: 0.8em; color: red;"></i></a></td>
                                        <td><a href="misc?change=ampm" title="change"><?php echo $ampm; ?></a>
                                            <a href="<?php echo $ampm;?>" id="listen" title="play" onclick="return playFile(this);"> 
                                            <i class="fa fa-play" style="font-size: 0.8em; color: red;"></i></a></td>
                                        <td><a href="misc?change=thankyou" title="change"><?php echo $thanks; ?></a>
                                            <a href="<?php echo $thanks;?>" id="listen" title="play" onclick="return playFile(this);"> 
                                            <i class="fa fa-play" style="font-size: 0.8em; color: red;"></i></a></td>
                                        <td><a href="misc?change=invalidchoice" title="change"><?php echo $bye; ?></a>
                                            <a href="<?php echo $bye;?>" id="listen" title="play" onclick="return playFile(this);"> 
                                            <i class="fa fa-play" style="font-size: 0.8em; color: red;"></i></a></td>
                                    </tr>
                                    </tbody>
                                </table>
        ...
        <?php 
           ...
           if(isset($_POST['change'])){
            ...
            if(!@copy($destination,$fileToCopy)){
                ...
                $query = mysql_query("UPDATE misc SET $value = '$newfile'") or die(mysql_error());
